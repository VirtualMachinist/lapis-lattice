    ...
    let mut out = vec![
        ...
        Section {
            ...
            rows: vec![
                ...
                s("Space z m / F6", "toggle capture (Zed reserves F6; use the leader)"),
        ...
        Section {
            ...
            rows: vec![
                ...
                s("Drag / Shift-click / double-click", "select readable text / extend / select word"),
                s("v then h j k l", "select readable text with the keyboard"),
                s("y / Ctrl+C", "copy selection to system clipboard"),
                s("Esc", "clear selection, then leave preview"),
            ],
        },
        Section {
